...
const schema = z.object({
  ...
  precio_costo: z.number({ invalid_type_error: 'Debe ser ≥ 0' }).min(0, 'Debe ser ≥ 0'),
  precio_venta: z.number({ invalid_type_error: 'Debe ser ≥ 0' }).min(0, 'Debe ser ≥ 0'),
  stock: z.number({ invalid_type_error: 'Debe ser ≥ 0' }).int().min(0, 'Debe ser ≥ 0'),
  stock_minimo: z.number({ invalid_type_error: 'Debe ser ≥ 0' }).int().min(0, 'Debe ser ≥ 0'),
